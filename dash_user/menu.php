<header class="main-header"><nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#"><b> APK | KARTU PELAJAR</b></a>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a target='_blank' href="cetak.php?id=<?php echo $_SESSION['id']; ?>"><i class="fa fa-print"></i> CETAK KARPEL</a></li>
				<li><a target='_blank' href="cetak1.php?id=<?php echo $_SESSION['id']; ?>"><i class="fa fa-print"></i> CETAK KARPUS</a></li>
