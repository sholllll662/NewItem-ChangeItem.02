...
if (isset($_FILES['berkas_excel']['name']) && in_array($_FILES['berkas_excel']['type'], $file_mimes)) {
    ...
    for ($i = 1; $i < count($sheetData); $i++) {
        ...
        $tgleng = date("Y-m-d H:i:s");

        mysqli_query($koneksi, "INSERT INTO itembc (part_no, part_name, customer, reason, pic, material_rmcode, rm_stock, rm_stockJ, rm_weight, weight_consum, rm_use, proces1, proces2, proces3, proces4, proces5, proces6, proces7, proces8, proces9, proces10, proces11, proces12, proces13, proces14, proces15, proces16, currency, unit_price, reason_price, part_stock, amalgamasi, part_stockJ, unit_length, item_pcs, std_packing, packing, ct, weight_part, weightconsumn, rawmatppic, dept, model, id_level, lampiran, keputusan, tglmkt, tgleng, tglppic2, tglspveng, tglqc, tglppic, tglgm, tglppic3, tglit, cutoffprod, cutoffsales) VALUES ('$part_no1','$part_name1','$customer1','$reason1','$pic','$material_rmcode1','$rm_stock1','$rm_stockJ1','$rm_weight1','$weight_consum1','$rm_use1','$proces1bc','$proces2bc','$proces3bc','$proces4bc','$proces5bc','$proces6bc','$proces7bc','$proces8bc','$proces9bc','$proces10bc','$proces11bc','$proces12bc','$proces13bc','$proces14bc','$proces15bc','$proces16bc','$currency1','$unit_price1','$reason_price1','$part_stock1','$amalgamasi1','$part_stockJ1','$unit_length1','$item_pcs1','$std_packing1','$packing1','$ct1','$weight_part1','$weightconsumnppic','$rawmatppic','$dept','$model','$level','$namaFile','$keputusan','$tglmkt','$tgleng','$tglppic2','$tglspveng','$tglqc','$tglppic','$tglgm','$tglppic3','$tglit','$cutoffprod','$cutoffsales')");
