  ...
  <section class="content">
      ...
      <div class="col-md-4">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where material_rmcode ='' AND id_level IN ('8') "));
                                          echo "$data"; ?> ITEM</span>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-aqua">
        ...
        <a href="create-data" class="small-box-footer" style="color: white;">Tambah Sekarang <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-aqua">
        ...
        <a href="create-data2" class="small-box-footer" style="color: white;">Tambah Sekarang <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <div class="col-lg-3 col-xs-6">
