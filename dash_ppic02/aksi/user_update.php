...
//---------------------------------------------
// $level = 2;                                |
// $keputusan = 'WAITING INPUT to SAP by IT'; |
//---------------------------------------------
// $dept = '';
// $tglmkt = '';
// $model = '';
...
mysqli_query($koneksi, "UPDATE newitem SET RMWeightConsume='$RMWeightConsume', rawmatppic='$rawmatppic', tglinputppic='$tgl' WHERE id = '$_POST[id]'");
