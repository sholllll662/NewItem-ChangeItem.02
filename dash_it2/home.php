      ...
      <div class="col-md-4">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Approved By GM MKT') AND id_level='3' "));
                                          echo "$data"; ?> ITEM</span>
    ...
    $(document).ready(function() {
      ...
      function showNotification(title, message) {
        if (Notification.permission !== "granted") {
          ...
          <?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Approved By GM MKT') AND id_level='3' ")); ?>
        } else {
