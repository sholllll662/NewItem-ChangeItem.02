      ...
      <div class='row'>
        <div class='col-md-12'>
          <div class='box box-success'>
            ...
            <form class='form-horizontal' role='form' method=POST action='aksi/user_update2.php' enctype='multipart/form-data'>
              <div class='box-body'>
                <?php
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <select name='wait' class='form-control'>
                        <option value='Waiting Approval GM HRD IT' selected>Waiting Approval GM HRD IT</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='f1' value="<?php echo $rr['material_rmcodebc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>MATERIAL RM CODE : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='f2' value="<?php echo $rr['material_rmcodeac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM STOCK : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='g1' value="<?php echo $rr['rm_stockbc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>RM STOCK : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='g2' value="<?php echo $rr['rm_stockac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM STOCK JUDGEMENT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='h1' value="<?php echo $rr['rm_stockJbc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>RM STOCK JUDGEMENT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='h2' value="<?php echo $rr['rm_stockJac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM WEIGHT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='i1' value="<?php echo $rr['rm_weightbc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>RM WEIGHT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='i2' value="<?php echo $rr['rm_weightac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label' style="font-size: 13px;">RM Weight Consumption : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='j1' value="<?php echo $rr['weight_consumbc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label' style="font-size: 13px;">RM Weight Consumption : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='j2' value="<?php echo $rr['weight_consumac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM USE Kg/M : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='k1' value="<?php echo $rr['rm_usebc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>RM USE Kg/M : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='k2' value="<?php echo $rr['rm_useac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-1'>
                      <input type='text' class='form-control' name='mm1' value="<?php echo $rr['currencybc']; ?>" readonly>
                    </div>
                    ...
                    <label class='col-sm-2 control-label'>CURRENCY : </label>
                    <div class='col-sm-1'>
                      <input type='text' class='form-control' name='mm1' value="<?php echo $rr['currencyac']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label' style="margin-left: -7cqmax;">UNIT PRICE : </label>
                    <div class='col-sm-2'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='r1' value="<?php echo $rr['unit_lengthbc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>UNIT LENGTH : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='r2' value="<?php echo $rr['unit_lengthac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='date' class='form-control' name='x1' value="<?php echo $rr['cutoffprodac']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>Sales (By Mkt) : </label>
                    <div class='col-sm-4'>
                      <input type='date' class='form-control' name='x2' value="<?php echo $rr['cutoffsalesac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                ...
                <div class='box-footer'>
                  ...
                  <a href="view-data2" class='col-sm-5'><button style="width: 200px" type="button" class="btn btn-flat btn-danger"><i class="glyphicon glyphicon-floppy-remove"></i> B A T A L</button></a>
                </div>
              </div>
            </form>
          </div>
