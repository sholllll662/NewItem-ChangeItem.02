              ...
              <div class='box-body'>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='date' class='form-control' name='ec' value="<?php
                                                                                $dept = $rr['dept'];
                                                                                if ($dept == 'Engineering') {
                                                                                  echo "$rr[tglengbc]";
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <select name='ae' class='form-control'>
                        ...
                        <option value='Approved by GM MKT'>Approved by GM</option>
                        <option value='Approved by ASMEN PPIC'>Approved by ASMEN PPIC</option>
                        <option value='Approved by SPV QC'>Approved by SPV QC</option>
                        <option value='Approved by SPV Engineering'>Approved by SPV Engineering</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='a1' value="<?php echo $rr['part_nobc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>PART NO :</label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='a2' value="<?php echo $rr['part_noac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>PART NAME : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='b1' value="<?php echo $rr['part_namebc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>PART NAME : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='b2' value="<?php echo $rr['part_nameac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>COSTUMER :</label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='c1' value="<?php echo $rr['customerbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>COSTUMER :</label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='c2' value="<?php echo $rr['customerac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>REASON CHANGE :</label>
                    <div class='col-sm-10'>
                      <input type='text' class='form-control' name='d1' value="<?php echo $rr['reasonbc']; ?>">
                    </div>
                    <!-- <label class='col-sm-2 control-label'>REASON CHANGE :</label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='d2' value="<?php echo $rr['reasonac']; ?>">
                    </div> -->
                  </div>
                  <div class='form-group'>
                    ...
                    <!-- <label class='col-sm-2 control-label'>CHANGE REQUEST PIC : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='e2' value="<?php echo $rr['picac']; ?>">
                    </div> -->
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='g1' value="<?php echo $rr['rm_stockbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>RM STOCK : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='g2' value="<?php echo $rr['rm_stockac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM STOCK JUDGEMENT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='h1' value="<?php echo $rr['rm_stockJbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>RM STOCK JUDGEMENT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='h2' value="<?php echo $rr['rm_stockJac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM WEIGHT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='i1' value="<?php echo $rr['rm_weightbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>RM WEIGHT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='i2' value="<?php echo $rr['rm_weightac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='k1' value="<?php echo $rr['rm_usebc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>RM USE Kg/M : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='k2' value="<?php echo $rr['rm_useac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-1'>
                      <input type='text' class='form-control' name='mm1' value="<?php echo $rr['currencybc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label' style="margin-left: -7cqmax;">UNIT PRICE : </label>
                    <div class='col-sm-2'>
                      <input type='text' class='form-control' style="margin-left: -1cqmax;" name='m1' value="<?php echo $rr['unit_pricebc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>CURRENCY : </label>
                    <div class='col-sm-1'>
                      <input type='text' class='form-control' name='mm1' value="<?php echo $rr['currencyac']; ?>">
                    </div>
                    <label class='col-sm-2 control-label' style="margin-left: -7cqmax;">UNIT PRICE : </label>
                    <div class='col-sm-2'>
                      <input type='text' class='form-control' style="margin-left: -1cqmax;" name='m2' value="<?php echo $rr['unit_priceac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>REASON CHANGE PRICE : </label>
                    <div class='col-sm-10'>
                      <input type='text' class='form-control' name='n1' value=" <?php echo $rr['reason_pricebc']; ?>">
                    </div>
                    <!-- <label class='col-sm-2 control-label'>REASON CHANGE PRICE : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='n2' value="<?php echo $rr['reason_priceac']; ?>">
                    </div> -->
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>Part STOCK : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='o1' value="<?php echo $rr['part_stockbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>Part STOCK : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='o2' value="<?php echo $rr['part_stockac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>Amalgamasi Stock (By Eng) : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='p1' value="<?php echo $rr['amalgamasibc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>Amalgamasi Stock (By Eng) : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='p2' value="<?php echo $rr['amalgamasiac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>Part STOCK JUDGEMENT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='q1' value="<?php echo $rr['part_stockJbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>Part STOCK JUDGEMENT : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='q2' value="<?php echo $rr['part_stockJac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='s1' value="<?php echo $rr['item_pcsbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>RM BAR/ITEM PCS : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='s2' value="<?php echo $rr['item_pcsac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>STD. PACKING : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='t1' value="<?php echo $rr['std_packingbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>STD. PACKING : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='t2' value="<?php echo $rr['std_packingac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='v1' value="<?php echo $rr['ctbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>C/T : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='v2' value="<?php echo $rr['ctac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>WEIGHT PART : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='w1' value="<?php echo $rr['weight_partbc']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>WEIGHT PART : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='w2' value="<?php echo $rr['weight_partac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='date' class='form-control' name='x1' value="<?php echo $rr['cutoffprodac']; ?>">
                    </div>
                    <label class='col-sm-2 control-label'>Sales (By Mkt) : </label>
                    <div class='col-sm-4'>
                      <input type='date' class='form-control' name='x2' value="<?php echo $rr['cutoffsalesac']; ?>">
                    </div>
                  </div>
                  <div class='form-group'>
