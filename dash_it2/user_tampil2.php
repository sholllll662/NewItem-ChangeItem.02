            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $tampil = mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Approved By GM MKT') AND id_level='3' ORDER BY id DESC");
                    $no = 1;
                    ...
                    <tr>
                      ...
                      <td><center>
                        ...
                        <a class='btn bg-aqua btn-xs' data-toggle='tooltip' title='Ubah Data' href='update-data1?id=$rr[id]'><span class='glyphicon glyphicon-edit'></span></a>
                      </td><center>";
                      $no++;
                    } ?>
                    </tr>
