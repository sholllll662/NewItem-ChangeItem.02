        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="glyphicon glyphicon-tasks"></i> DATA ITEMS MASTER</h3>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><center>
                        ...
                        <a class='btn bg-aqua btn-xs' data-toggle='tooltip' title='Ubah Data' href='update-data?id=$rr[id]'><span class='glyphicon glyphicon-edit'></span></a>
                        <a class='btn bg-red btn-xs' data-toggle='tooltip' title='Hapus Data' href='aksi/user_hapus.php?id=$rr[id]' onclick='return confirmDelete();'><span class='glyphicon glyphicon-trash'></span></a></center>
                      </td>";
                      $no++;
                    } ?>
                    </tr>
