    ...
    <section class="sidebar">
      ...
      <div class="user-panel" style="padding-bottom: 20px;">
        <div class="pull-left image"><?php $query = mysqli_query($koneksi, "SELECT * FROM user WHERE username='$username' AND password='$password'"); ?>
          <img src="../assets/img/user/<?php if (trim($_SESSION['gambar']) == '') {
                                          echo "blank.png";
                                        } else {
        ...
        <div class="pull-left info">
          <p style="margin-top: 4px;"><span><?php echo $_SESSION['nama']; ?></span></p>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="user_tampil2.php">
            <i class="fa fa-list-ol"></i> <span>LIHAT DATA</span>
            </span>
          </a>
        <li class="treeview">
          <a href="user_tampil4.php">
            <i class="fa fa-inbox"></i> <span>APPROVE</span>
            </span>
          </a>
