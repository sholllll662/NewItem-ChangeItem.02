        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <a href='excel_export2.php' class="pull-right btn bg-purple"><i class="glyphicon glyphicon-export"></i> EXPORT DATA</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                  <?php
                  $tampil = mysqli_query($koneksi, "SELECT * FROM newitem WHERE keputusan IN ('Approved by GM HRD IT') AND id_level IN ('1') ORDER BY id DESC");
                  $no=1;
