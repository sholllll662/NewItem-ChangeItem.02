...
$tgl = date("Y-m-d");
$time = date("G:i:s");
mysqli_query($koneksi, "UPDATE user SET id_level='$approve1' WHERE id = '2'");
mysqli_query($koneksi, "UPDATE user SET id_level='$approve2' WHERE id = '3'");
...
window.location='/NewItem-ChangeItem/dash_it/user_tampil4.php'</script>";
