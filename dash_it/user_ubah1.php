            ...
            <form class='form-horizontal' role='form' method=POST action='aksi/user_update2.php' enctype='multipart/form-data'>
              <div class='box-body'>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <input type='text' class='form-control' name='aw' value="<?php echo $rr['RMWeightConsume']; ?>" readonly>
                  </div>
                  <label class='col-sm-2 control-label'>RAWMAT FROM PPIC : </label>
                  <div class='col-sm-4'>
                    <input type='text' class='form-control' name='ax' value="<?php echo $rr['rawmatppic']; ?>" readonly>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 control-label'>STATUS :</label>
                  <div class='col-sm-4'>
                    <select name='agm' class='form-control' required autocomplete="off">
