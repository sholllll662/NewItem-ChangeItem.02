        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="glyphicon glyphicon-tasks"></i> DATA NEW ITEMS</h3>
              <a href='excel_export.php' class="pull-right btn bg-purple"><i class="glyphicon glyphicon-export"></i> EXPORT DATA</a>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $tampil = mysqli_query($koneksi, "SELECT * FROM newitem WHERE keputusan IN ('Approved by GM MKT') AND id_level='3' ORDER BY id DESC");
                    $no = 1;
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                            ...
                            <a class='btn bg-aqua btn-xs' data-toggle='tooltip' title='Ubah Data' href='update-data1?id=<?php echo $rr["id"]; ?>'><span class='glyphicon glyphicon-edit'></span></a>
                        </td>
                      <?php $no++;
                    } ?>
                      </tr>
