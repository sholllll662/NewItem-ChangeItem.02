      ...
      <div class="col-md-4">
        <div class="info-box bg-aqua">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Approved by ASMEN PPIC') AND id_level='4' "));
                                          echo "$data"; ?> ITEM</span>
      ...
      $(document).ready(function() {
        ...
        function showNotification(title, message) {
          if (Notification.permission !== "granted") {
            ...
            <?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Approved by ASMEN PPIC') AND id_level='4' ")); ?>
          } else {
