...
mysqli_query($koneksi, "UPDATE itembc a INNER JOIN itemac c ON a.id = c.id SET a.tglgm = '$tgl', 
                                                                                   a.keputusan = '$keputusan', 
                                                                                   a.id_level = '$level',
                                                                                   a.catatan_gm = '$catatan_gm',
                                                                                   c.catatan_gm = '$catatan_gm',
                                                                                   c.tglgm = '$tgl', 
