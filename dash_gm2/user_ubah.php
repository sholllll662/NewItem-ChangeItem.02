                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <select name='ae' class='form-control' required autocomplete="off">
                        ...
                        <option value='Approved By GM MKT'>Approve</option>
                        <option value='Disapproved By GM MKT'>Disapprove</option>
                      </select>
                    </div>
                    <label class='col-sm-2 control-label'>Catatan : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='cct' value="<?php echo $rr['catatanbc']; ?>">
                    </div>
                  </div>
                </div>
                <br>
