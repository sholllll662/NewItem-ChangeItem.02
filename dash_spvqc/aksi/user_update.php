...
mysqli_query($koneksi, "UPDATE itembc a INNER JOIN itemac c ON a.id = c.id SET a.tglqc = '$tgl', 
                                                                                   a.keputusan = '$keputusan', 
                                                                                   a.id_level = '$level',
                                                                                   a.catatan_spvqc = '$catatan_spvqc',
                                                                                   c.catatan_spvqc = '$catatan_spvqc',
                                                                                   c.tglqc = '$tgl', 
