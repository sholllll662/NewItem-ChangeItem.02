      ...
      <div class="col-md-4">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            <span class="info-box-text">WAITING APPROVAL ASMEN PPIC</span>
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Approved By SPV QC') AND id_level IN ('5') "));
                                          echo "$data"; ?> ITEM</span>
      ...
      <div class="col-md-4">
        <div class="info-box bg-red">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Disapproved by ASMEN PPIC', 'Disapproved by GM MKT') AND id_level IN ('6', '4', '3', '2', '1') "));
                                          echo "$data"; ?> ITEM</span>
            <!-- The progress section is optional -->
            <div class="progress">
              <div class="progress-bar" style="width: 100%"></div>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-orange">
        <div class="inner">
          ...
          <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Approved by SPV Eng') AND id_level='6'"));
                                        echo "$data"; ?> ITEM</span>
        </div>
        <div class="icon">
    ...
    $(document).ready(function() {
      ...
      function showNotification(title, message) {
        if (Notification.permission !== "granted") {
          ...
          <?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Approved by SPV Eng') AND id_level='6'")); ?>
        } else {
