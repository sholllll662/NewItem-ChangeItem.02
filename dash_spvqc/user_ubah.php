                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <select name='ae' class='form-control' required autocomplete="off">
                        ...
                        <option value='Approved By SPV QC'>Approve</option>
                        <option value='Disapproved By SPV QC'>Disapprove</option>
                      </select>
                    </div>
