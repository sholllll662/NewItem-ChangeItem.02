      ...
      <div class="col-md-4">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM newitem where keputusan IN ('Waiting Approval GM HRD IT') AND id_level='1' "));
                                          echo "$data"; ?> ITEM</span>
      ...
      <div class="col-md-4">
        <div class="info-box bg-green">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM newitem where keputusan IN ('Approved by GM HRD IT') AND id_level='1' "));
                                          echo "$data"; ?> ITEM</span>
            <!-- The progress section is optional -->
            <div class="progress">
              <div class="progress-bar" style="width: 100%"></div>
    ...
    $(document).ready(function() {
      ...
      function showNotification(title, message) {
        if (Notification.permission !== "granted") {
          ...
          <?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM newitem where keputusan IN ('Waiting Approval GM HRD IT') AND id_level='1'  ")); ?>
        } else {
