              ...
              <div class='box-body'>
                ...
                <label class='col-sm-2 control-label'>Currency :</label>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='l25'>
                    </div>
                    <label class='col-sm-2 control-label'>PROCESS 13 : </label>
                    <div class='col-sm-4'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='l27'>
                    </div>
                    <label class='col-sm-2 control-label'>PROCESS 14 : </label>
                    <div class='col-sm-4'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='l29'>
                    </div>
                    <label class='col-sm-2 control-label'>PROCESS 15 : </label>
                    <div class='col-sm-4'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='l31'>
                    </div>
                    <label class='col-sm-2 control-label'>PROCESS 16 : </label>
                    <div class='col-sm-4'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <input type='number' step="0.1" class='form-control' name='m1' id="m1">
                    </div>
                    <label class='col-sm-2 control-label'>Unit Price :</label>
                    <div class='col-sm-4'>
                ...
                <div class='box-footer'>
                  <label class='col-sm-2 control-label'></label>
                  <div class='col-sm-10'>
                    <button style='width: 150px;' type="submit" class="btn btn-flat btn-primary"><i class="glyphicon glyphicon-floppy-save" onclick="return confirm('Apa anda yakin data sudah benar?')"></i> S I M P A N</button>
