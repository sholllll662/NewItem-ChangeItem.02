...
mysqli_query($koneksi, "UPDATE itembc a INNER JOIN itemac c ON a.id = c.id SET a.tglspveng = '$tgl', 
                                                                                   a.keputusan = '$keputusan',
                                                                                   a.material_rmcode = '$material_rmcode1',
                                                                                   a.id_level = '$level',
                                                                                   a.catatan_spveng = '$catatan_spveng',
                                                                                   c.catatan_spveng = '$catatan_spveng',
                                                                                   c.tglspveng = '$tgl', 
