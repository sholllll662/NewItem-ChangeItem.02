        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="glyphicon glyphicon-tasks"></i> LIST DATA PENGAJUAN CHANGE ITEMS</h3>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $tampil = mysqli_query($koneksi, "SELECT * FROM itemac WHERE id_level IN ('7') ORDER BY id DESC");
                    $no = 1;
