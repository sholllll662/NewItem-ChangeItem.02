            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                  $tampil = mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Disapproved by SPV QC', 'Disapproved by ASMEN PPIC', 'Disapproved by GM MKT') AND id_level IN ('7', '6', '4', '3', '2', '1') ORDER BY id DESC");
                  $no=1;
