            ...
            <form class='form-horizontal' role='form' method=POST action='aksi/user_update.php' enctype='multipart/form-data'>
              <div class='box-body'>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <input type='text' class='form-control' name='ab' required autocomplete="off">
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 control-label'>U MIS StdPacking : </label>
                  <div class='col-sm-4'>
                    <input type='text' class='form-control' name='ac' required autocomplete="off">
                  </div>
                  <label class='col-sm-2 control-label'>U MIS CycleTime : </label>
                  <div class='col-sm-4'>
                    <input type='text' class='form-control' name='ad' required autocomplete="off">
                  </div>
                </div>
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <select name='ae' class='form-control' required autocomplete="off">
                      ...
                      <option value='Approved by Eng'>Approve</option>
                      <option value='Disapproved by Eng'>Disapprove</option>
                    </select>
                  </div>
                  <label class='col-sm-2 control-label'>Catatan Engineering : </label>
                  <div class='col-sm-4'>
                    <textarea type='text' class='form-control' name='nb'></textarea>
                  </div>
                </div>
                <div class='form-group'>
