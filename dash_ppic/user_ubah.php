                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <select name='ae' class='form-control' required autocomplete="off">
                        ...
                        <option value='Approved By ASMEN PPIC'>Approve</option>
                        <option value='Disapproved By ASMEN PPIC'>Disapprove</option>
                      </select>
                    </div>
