      ...
      <div class="col-md-4">
        <div class="info-box bg-yellow">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Approved by ASMEN PPIC') AND id_level IN ('4') "));
                                          echo "$data"; ?> ITEM</span>
      ...
      <div class="col-md-4">
        <div class="info-box bg-red">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac where keputusan IN ('Disapproved by GM MKT') AND id_level IN ('3', '2', '1') "));
                                          echo "$data"; ?> ITEM</span>
            <!-- The progress section is optional -->
            <div class="progress">
              <div class="progress-bar" style="width: 100%"></div>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-orange">
        <div class="inner">
          ...
          <p>Request Approval Change Item</p>
          <span class="info-box-number"><?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Approved by SPV QC') AND id_level='5'"));
                                        echo "$data"; ?> ITEM</span>
        </div>
        <div class="icon">
    ...
    $(document).ready(function() {
      ...
      function showNotification(title, message) {
        if (Notification.permission !== "granted") {
          ...
          <?php $data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM itemac WHERE keputusan IN ('Approved by SPV QC') AND id_level='5'")); ?>
        } else {
