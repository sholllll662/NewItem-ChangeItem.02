              ...
              <div class='form-group'>
                ...
                <div class="col-sm-6 table-responsive">
                  <table>
                    ...
                    <tr>
                      <td class="col-sm-5" style="font-size: 18px;"><b>Catatan SpvEng</b></td>
                      <td style="font-size: 18px;"><b>: <?php echo $rr['catatan_asmenppic']; ?></b></td>
                    </tr>
                    <tr>
                ...
                <div class="col-sm-6 table-responsive">
                  <table>
                    ...
                    <tr>
                      <td class="col-sm-9" style="font-size: 18px; border: 2px solid black; text-align: center; vertical-align: middle; padding: 10px"><b>Model : <?php echo $rr['model']; ?></b></td>
