        ...
        <div class='col-md-12'>
          <div class='box box-success'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class='fa fa-edit'></i> FORM NEW ITEM MASTER</h3>
            </div>
            <form class='form-horizontal' role='form' method=POST action='aksi/user_simpan1.php' enctype='multipart/form-data'>
              <div class='box-body'>
                <div class='form-group'>
                  <a style="margin-left: 140px; font-size: 18px; text-align: center; vertical-align: middle;" href='../assets/master/Master File New Items.xls'>Download File Master</a>
                </div>
                <br>
                <div class='form-group'>
