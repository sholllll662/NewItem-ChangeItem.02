            ...
            <div class="box-body">
              <div class="table-responsive">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                  <?php
                  $tampil = mysqli_query($koneksi, "SELECT * FROM newitem WHERE keputusan IN ('Disapproved by Eng', 'Disapproved by QC', 'Disapproved by GM MKT', 'Disapproved by GM HRD IT') AND id_level IN ('9', '5', '3', '2', '1') ORDER BY id DESC");
                  $no=1;
