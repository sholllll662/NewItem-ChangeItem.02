<?php
    ...
    $reason1 = $_POST['d1']; $reason2 = $_POST['d2'];
    $pic1 = $_POST['e1']; $pic2 = $_POST['e2'];
    ...
    $reason_price1 = $_POST['n1']; $reason_price2 = $_POST['n2'];
    ...
    mysqli_query($koneksi, "UPDATE itembc a INNER JOIN itemac c ON a.id = c.id SET a.tglppic3 = '$tgl', 
                                                                                   a.keputusan = '$keputusan', 
                                                                                   a.id_level = '$level',
                                                                                   a.weightconsumn = '$weightconsumn',
                                                                                   a.rawmatppic = '$rawmat',
                                                                                   c.tglppic3 = '$tgl', 
                                                                                   c.keputusan = '$keputusan', 
                                                                                   c.id_level = '$level',
                                                                                   c.weightconsumn = '$weightconsumn',
                                                                                   c.rawmatppic = '$rawmat' 
