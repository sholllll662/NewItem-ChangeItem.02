              ...
              <div class='box-body'>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-4'>
                      <select name='ae' class='form-control' required autocomplete="off">
                        <option value='' selected></option>
                        <option value='Waiting Register to SAP'>Approve</option>
                ...
                <div style="border: 2px solid black;">
                  ...
                  <div class='form-group'>
                    <label class='col-sm-2 control-label' style="margin-left: 330px; font-size: 18px; border: 2px solid black; text-align: center; vertical-align: middle;">BEFORE CHANGE</label>
                    <label class='col-sm-2 control-label' style="margin-left: 450px; font-size: 18px; border: 2px solid black; text-align: center; vertical-align: middle;">AFTER CHANGE</label>
                  </div>
                  <div class='form-group'>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    <label class='col-sm-2 control-label'>RM Weight Consumption : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='j1' value="<?php echo $rr['weight_consumac']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>RM Weight Consumption : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='j2' value="<?php echo $rr['weight_consumbc']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-2'>
                      <input type='text' class='form-control' name='m1' value="<?php echo $rr['unit_pricebc']; ?>" readonly>
                    </div>
                    <label class='col-sm-2 control-label'>CURRENCY : </label>
                    <div class='col-sm-1'>
                    ...
                    <label class='col-sm-2 control-label' style="margin-left: -112px;">UNIT PRICE : </label>
                    <div class='col-sm-2'>
                      <input type='text' class='form-control' name='m2' value="<?php echo $rr['unit_priceac']; ?>" readonly>
                    </div>
                  </div>
                  <div class='form-group'>
                  ...
                  <br>
                  <div class='form-group'>
                  <label class='col-sm-2 control-label'>WEIGHTCONSUMN FROM PPIC : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='weight'>
                    </div>
                    <label class='col-sm-2 control-label'>RAWMAT PROM PPIC : </label>
                    <div class='col-sm-4'>
                      <input type='text' class='form-control' name='rawmat'>
                    </div>
                  </div>
                ...
                <div style="border: 2px solid black;">
                  <br>
                  <div class='form-group'>
                    <label class='col-sm-2 control-label' style="font-size: 18px; margin-left: 550px; border: 2px solid black; text-align: center; vertical-align: middle;">DATE CUT OFF</label>
                  </div>
                  <br>
                  <div class='form-group'>
